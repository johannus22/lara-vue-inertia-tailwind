        ...
        <header>
            <nav>
                <div class="space-x-6">
                    ...
                    :class="{'bg-slate-900': $page.component === 'Home'}"
                    >Home</Link>
                </div>
                <div v-if="$page.props.auth.user" class="space-x-6 flex">
                    ...
                    : 'storage/avatars/default.jfif'"
                    alt="">


                    <Link :href="route('dashboard')" class="nav-link"
                    :class="{'bg-slate-900': $page.component === 'Dashboard'}"
                    >Dashboard</Link>
                ...
                <div v-else class="space-x-6">
                    ...
                    :class="{'bg-slate-900': $page.component === 'Auth/Register'}"
                    >Register</Link>

                    <Link :href="route('login')" class="nav-link"
                    :class="{'bg-slate-900': $page.component === 'Auth/Login'}"
                    >Login</Link>
                </div>
            </nav>
        </header>
